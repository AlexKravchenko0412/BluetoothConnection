package android.example.bluetoothconnection;
        ...
        public void run()
        {
            ...
            } catch(Exception e) //obsolete way how to open BT
            {
                try
                {
                    ...
                    @SuppressLint("MissingPermission") BluetoothServerSocket tmpsocket = adapter.listenUsingRfcommWithServiceRecord(NAME, MY_UUID);
